...
namespace gregorian {
  ...
  operator>>(std::basic_istream<CharT, Traits>& is, date& d)
  {
    ...
    if (strm_sentry) {
      try {
        typedef typename date_time::date_input_facet<date, CharT> date_input_facet_t;
        
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, d);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
  ...
  operator>>(std::basic_istream<CharT, Traits>& is, date_duration& dd)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, dd);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
  ...
  operator>>(std::basic_istream<CharT, Traits>& is, date_period& dp)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, dp);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
  ...
  operator>>(std::basic_istream<CharT, Traits>& is, greg_month& m)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, m);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
  ...
  operator>>(std::basic_istream<CharT, Traits>& is, greg_weekday& wd)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, wd);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
  ...
  operator>>(std::basic_istream<CharT, Traits>& is, greg_day& gd)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, gd);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
  ...
  operator>>(std::basic_istream<CharT, Traits>& is, greg_year& gy)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, gy);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
  ...
  operator>>(std::basic_istream<CharT, Traits>& is, partial_date& pd)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, pd);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
             ...
             nth_day_of_the_week_in_month& nday)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, nday);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
             ...
             first_day_of_the_week_in_month& fkd)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, fkd);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
             ...
             last_day_of_the_week_in_month& lkd)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, lkd);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
             ...
             first_day_of_the_week_after& fka)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, fka);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
             ...
             first_day_of_the_week_before& fkb)
  {
    ...
    if (strm_sentry) {
      try {
        ...
        std::istreambuf_iterator<CharT,Traits> sit(is), str_end;
        if(std::has_facet<date_input_facet_t>(is.getloc())) {
          std::use_facet<date_input_facet_t>(is.getloc()).get(sit, str_end, is, fkb);
        }
        else {
          date_input_facet_t* f = new date_input_facet_t();
          std::locale l = std::locale(is.getloc(), f);
